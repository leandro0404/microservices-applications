  ...
  useEffect(() => {
    const fetchAccountData = async () => {
      try {
        ...
        console.log('AccountProvider - Token global:', window.appProfileToken ? 'Presente' : 'Ausente');
        
        // Se já existe um token global e não foi fornecido um novo token, use o global
        if (!externalToken && window.appProfileToken) {
          idToken = window.appProfileToken;
        ...
        window.appProfileToken = idToken;
